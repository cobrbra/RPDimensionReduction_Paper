...
\begin{figure}
    \centering
    \includegraphics[width=6in]{figures/sim1_ev.png}
    \caption{Caption}
    \label{fig:sim1_ev}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=6in]{figures/sim2_ev.png}
    \caption{Caption}
    \label{fig:sim2_ev}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=6in]{figures/sim3_ev.png}[]
    \caption{Caption}
    \label{fig:sim3_ev}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=6in]{figures/sim4_ev.png}
    \caption{Caption}
    \label{fig:sim4_ev}
\end{figure}
